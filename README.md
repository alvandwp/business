...
I have not used any CSS or JS frameworks in this project. I built it with the CSS float property, so this template is more compatible with older versions of browsers as well as new versions. Normalize.css has been used for cross-browser compatibility purposes.
